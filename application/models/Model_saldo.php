...
class Model_saldo extends CI_Model{
       ...
       private $table="dien035";
       
    function Tampilk(){
         $query=$this->db->get('dien035');
         return $query->result();
       }
	
    function tampilkan(){
       $this->db->SELECT('dien035.id,dien035.dien001_01,dien035.dien002_01,dien035.dien003_01,dien035.dien035_01,dien035.dien035_02,dien035.dien035_03,dien035.dien035_04,dien004.dien004_02,dien005.dien005_02,dien019.dien019_02,dien014.dien014_02');	
       $this->db->from('dien035');
	   $this->db->join('dien004','dien004.dien004_01=dien035.dien004_01');
	   $this->db->join('dien005','dien005.dien005_01=dien035.dien005_01');
	   $this->db->join('dien019','dien019.dien019_01=dien035.dien019_01');
	   $this->db->join('dien014','dien014.dien014_01=dien035.dien014_01');	   	   
       $query=$this->db->get();
       return $query->result();       
    }
