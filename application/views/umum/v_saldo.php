            ...
            <div class="row">
             <div class="col-sm-12">
              <table id="example1" class="table table-bordered table-striped" role="grid" aria-describedby="example1">               
                ...
                <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $row->dien034_01; ?></td>
                    <td><?php echo $row->dien034_02; ?>. <?php echo $row->dien034_03; ?>. <?php echo $row->dien034_04; ?></td>                    
                    <td><?php echo $row->dien034_05; ?></td>
                    <td><?php echo $row->dien034_06; ?></td>
                    <td><?php echo $row->dien034_07; ?></td>
                    <td><?php echo $row->dien034_08; ?></td>                    
                    <td><?php echo $row->dien034_09; ?></td>
                    <td><?php echo $row->dien034_10; ?></td>
                    <td><?php echo $row->dien034_11; ?></td>                    
                    <td>
