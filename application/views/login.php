...
<body>
  ...
  <div class="form">
  		<div align="center"><h3><strong><b>FORM LOGIN</b></strong></h3></div>
    ...
    <form class="login-form" action="<?php echo site_url('Auth/login') ?>" method="post">
      ...
      <input type="text" name="tahun" required="" placeholder="Tahun Anggaran"/>
      <button>login</button>     
    </form>
  </div>
</div>
...
<div align="center" class="copyright">
    <p>Copyright &copy; 2017. Created by Jimmy Febriadi</p>
 </div> 
