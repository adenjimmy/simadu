...
<section class="content">
     <div class="box">
        ...
        <li class="active"><a href="<?php echo site_url('rekening/rek6');?>">Rekening 6</a></li>
             ...
             <div class="col-sm-12">
              <table id="example1" class="table table-bordered table-striped" role="grid" aria-describedby="example1">               
                ...
                <tr>
                  ...
                  <th>Nama Rekening</th>
                  <th>Keterangan Rekening 6</th>                  
                  <th>Action</th>
               </tr>
                </thead>
                <tbody>
                    <?php $no=1; foreach($rek6 as $row){ ?>
                <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $row->dien006_01; ?>. <?php echo $row->dien007_01; ?>. <?php echo $row->dien008_01; ?>. <?php echo $row->dien009_01; ?>.
                    	<?php echo $row->dien010_01; ?>. <?php echo $row->dien011_01; ?></td>
                    
                    <td><?php echo $row->dien011_02; ?></td>
                    <td><?php echo $row->dien011_03; ?></td>
                    <td>
...
<script type="text/javascript">
 var save_method; //for save method string
    ...
    function edit_bid(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('rekening/edit_rek6/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="kado"]').val(data.dien009_01);
            $('[name="koda"]').val(data.dien010_01);
            $('[name="kada"]').val(data.dien011_01);
            $('[name="nama"]').val(data.dien011_02);
            $('[name="desk"]').val(data.dien011_03);            
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('rekening/tambah_rek6/')?>";
      }
      else
      {
        url = "<?php echo site_url('rekening/update_rek6/')?>";
      }
    ...
    function delete_bid(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('rekening/delete_rek6/')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <div class="modal modal-info" id="modal_form" role="dialog">
          ...
          <input type="hidden" value="" name="id"/>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <?php
					...
					echo form_dropdown("kodi",array('Pilih Rek'=>'-- Pilih Rekening --'),'',$style_rek3);					
					?>
                  <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <?php
					...
					echo form_dropdown("kado",array('Pilih Rek'=>'-- Pilih Rekening --'),'',$style_rek4);					
					?>
                  <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <?php
					...
					echo form_dropdown("koda",array('Pilih Rek'=>'-- Pilih Rekening --'),'',$style_rek5);					
					?>
                  <span class="help-block"></span>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="kada" readonly="" value=<?=$kodeunik;?> class="form-control " type="number" >
                <span class="help-block"></span>
              </div>
            </div>              
            <div class="form-group">
              <label class="control-label col-md-3">Rekening Level 6</label>
              <div class="col-md-9">
            ...
            <div class="form-group">
              <label class="control-label col-md-3">Deskrpsi Level 6</label>
              <div class="col-md-9">
                <input name="desk" required="" placeholder="Input Desk Rekening" class="form-control" type="text" >
                <span class="help-block"></span>
              </div>
            </div>                           
       		</div>      
