...
<section class="content">
     <div class="box">
        ...
        <li class="active"><a href="<?php echo site_url('rekening/rek5');?>">Rekening 5</a></li>
             ...
             <div class="col-sm-12">
              <table id="example1" class="table table-bordered table-striped" role="grid" aria-describedby="example1">               
                ...
                <tr>
                  ...
                  <th>Nama Rekening Level 5</th>                  
                  <th>Action</th>
               </tr>
                </thead>
                <tbody>
                    <?php $no=1; foreach($rek5 as $row){ ?>
                <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $row->dien006_01; ?>. <?php echo $row->dien007_01; ?>. <?php echo $row->dien008_01; ?>. <?php echo $row->dien009_01; ?>.
                    	<?php echo $row->dien010_01; ?> </td>
                    
                    <td><?php echo $row->dien010_02; ?></td>
                    <td>
...
<script type="text/javascript">
 var save_method; //for save method string
    ...
    function edit_bid(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('rekening/edit_rek5/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('rekening/tambah_rek5/')?>";
      }
      else
      {
        url = "<?php echo site_url('rekening/update_rek5/')?>";
      }
    ...
    function delete_bid(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('rekening/delete_rek5/')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <div class="modal modal-info" id="modal_form" role="dialog">
          ...
          <input type="hidden" value="" name="id"/>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="koda" readonly="" value=<?=$kodeunik;?> class="form-control " type="number" >
                <span class="help-block"></span>
              </div>
            </div>              
            <div class="form-group">
              <label class="control-label col-md-3">Nama Rekening Level 5</label>
              <div class="col-md-9">
