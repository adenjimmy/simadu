...
<section class="content">
     <div class="box">
        ...
        <li class="active"><a href="<?php echo site_url('rekening');?>" >Rekening 1</a></li> 
            ...
            <div class="row">
             <div class="col-sm-12">
              <table id="example1" class="table table-bordered table-striped" role="grid" aria-describedby="example1">               
                ...
                <tbody>
                    <?php $no=1; foreach($rek as $row){ ?>
                <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $row->dien006_01; ?></td>
                    <td><?php echo $row->dien006_02; ?></td>
                    <td>
...
<script type="text/javascript"> 
    ...
    function edit_bid(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('rekening/edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      {
        url = "<?php echo site_url('rekening/update/')?>";
      }
    ...
    function delete_bid(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('rekening/delete/')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <div class="modal modal-info" id="modal_form" role="dialog">
          ...
          <input type="hidden" value="" name="id"/>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="nama" id="nama" required="" placeholder="Input Nama Rekening" class="form-control" type="text" >
                <span class="help-block"></span>
              </div>
            </div>                
       		</div>      
