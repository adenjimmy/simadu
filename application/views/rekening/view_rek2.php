...
<section class="content">
     <div class="box">
        ...
        <li class="active"><a href="<?php echo site_url('rekening/rek2');?>" >Rekening 2</a></li>
            ...
            <div class="row">
             <div class="col-sm-12">
              <table id="example1" class="table table-bordered table-striped" role="grid" aria-describedby="example1">               
                ...
                <tr>
                  <th>No </th>
                  <th>Kode Rekening Level1</th>
                  <th>Kode Rekening Level2</th>
                  <th>Nama Rekening Level2</th>
                  <th>Action</th>
               </tr>
                </thead>
                <tbody>
                    <?php $no=1; foreach($rek2 as $row){ ?>
                <tr>
                    <td><?php echo $no; ?></td>
                    <td><?php echo $row->dien006_01; ?></td>
                    <td><?php echo $row->dien007_01; ?></td>
                    <td><?php echo $row->dien007_02; ?></td>
                    <td>
...
<script type="text/javascript"> 
    ...
    function edit_bid(id)
    {
      ...
      $.ajax({
        url : "<?php echo site_url('rekening/edit_rek2/')?>/" + id,
        type: "GET",
        dataType: "JSON",
    ...
    function save()
    {
      ...
      if(save_method == 'add')
      {
          url = "<?php echo site_url('rekening/tambah_rek2/')?>";
      }
      else
      {
        url = "<?php echo site_url('rekening/update_rek2/')?>";
      }
    ...
    function delete_bid(id)
    {
      if(confirm('Are you sure delete this data?'))
      {
        // ajax delete data from database
          $.ajax({
            url : "<?php echo site_url('rekening/delete_rek2/')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <div class="modal modal-info" id="modal_form" role="dialog">
          ...
          <input type="hidden" value="" name="id"/>
            <div class="form-group">
              ...
              <div class="col-md-9">
                <select class="form-control" name="kode" >
                      ...
                      <?php $cab = $this->db->get('dien006');
                        foreach ($cab->result()as $row){
                      ?>
                      <option class="form-control" value="<?php echo $row->dien006_01 ?>"><?php echo $row->dien006_01 ?> - <?php echo $row->dien006_02; ?></option>
                      <?php } ?>
                  </select>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input  name="kd" readonly="" value=<?=$kodeunik;?> class="form-control " type="number" >
                <span class="help-block"></span>
              </div>
            </div>              
            <div class="form-group">
              <label class="control-label col-md-3">Nama Rekening Level 2</label>
              <div class="col-md-9">
